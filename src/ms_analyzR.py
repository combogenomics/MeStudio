...
def ms_analyzR() -> tuple:
    ...
    ap.add_argument("-prt", "--prt_tab", help="Write in [OUT] tabular per-feature file ready for RCircos", action="store_true", default=False)
...
if split_flag == True:
    ...
    contig_list = f"grep 'ctg' {coding_ms} | cut -f 1 | uniq > {contigs_list_output}"
